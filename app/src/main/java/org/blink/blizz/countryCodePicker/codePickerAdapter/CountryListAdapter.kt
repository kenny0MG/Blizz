package org.blink.blizz.countryCodePicker.codePickerAdapter
...
import org.blink.blizz.databinding.ItemCountryBinding
import java.util.*
...
class CountryListAdapter(
    ...
    private var list = mutableListOf<CountryPickerItem>()
    var mFilteredList: List<CountryPickerItem>
    ...
    fun newList(newList: List<CountryPickerItem>) {
        list.clear()
        list.addAll(newList)
        ...
        return object : Filter() {
            override fun performFiltering(charSequence: CharSequence): Filter.FilterResults {
                ...
                if (charString.isEmpty()) {
                    ...
                    val filteredList = ArrayList<CountryPickerItem>()
            ...
            override fun publishResults(
                ...
                mFilteredList = filterResults.values as List<CountryPickerItem>
                notifyDataSetChanged()
            }
        }
    }
    ...
    interface OnItemClickListener {
        fun onSelectItem(item: CountryPickerItem)
    }
}