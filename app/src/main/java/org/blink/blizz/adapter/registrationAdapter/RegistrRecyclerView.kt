...
class VideoRecyclerView @JvmOverloads constructor(
    ...
    val playerVideo = SimpleExoPlayer.Builder(context.applicationContext).build()
    ...
    private fun findCurrentVideoPosition(): Int {
        ...
        val discoverAdapter = adapter as RegistrListAdapter
    ...
    private fun RegistrListAdapter.isItemVideo(position: Int): Boolean {
