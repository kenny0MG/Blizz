...
import org.blink.blizz.list.adapter.VideoPlayerEventListener
import org.blink.blizz.model.PostItem
import java.util.concurrent.TimeUnit

class PostVideoViewHolder(private val binding: PostVideoItemBinding, val onClick: (PostItem) -> Unit) :
